...
func (c *GeoService) RegisterUser(w http.ResponseWriter, r *http.Request) {
	var newUser User
...
func (c *GeoService) LoginUser(w http.ResponseWriter, r *http.Request) {
	var user User
...
func (c *GeoService) SearchAnswer(w http.ResponseWriter, r *http.Request) {
...
// @Failure 500 {object} errorResponce
// @Router /api/address/search [post]
func (c *GeoService) GeocodeAnswer(w http.ResponseWriter, r *http.Request) {
	var address Address
...
func (c *GeoService) NotFoundAnswer(w http.ResponseWriter, r *http.Request) {
